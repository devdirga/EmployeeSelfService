...
namespace KANO.Api.BatchJob
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // services.AddHostedService<CityUpdater>();
            services.AddHostedService<TravelUpdater>();
            services.AddHostedService<ApplicationUpdater>();
            services.AddHostedService<TrainingRegistrationUpdater>();
            services.AddHostedService<AgendaPushNotification>();
            //services.AddHostedService<DepartmentUpdater>();
        }
